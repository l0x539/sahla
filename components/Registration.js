...
export default class Registration extends Component {
    ...
    render() {
        ...
        <TabPanel>
            <form onSubmit={this.handleSignup} className="input">
                <div className="info-card info-card__content">
                    <h3 className="info-card__header">Create an account</h3>
                    <input type="text" name="username" className="input__main" placeholder="Username" />
                    <input type="email" name="email" className="input__main" placeholder="Email" />
                    <input type="password" onChange={this.handlePasswordStrengh} name="passwd" className="input__main" placeholder="Password" />
                    <input type="password" name="passwd2" className="input__main" placeholder="Confirm Password" />
                    <ReCAPTCHA
        ...
        <form onSubmit={this.handleLogin} className="input">
                <div className="info-card info-card__content">
                    <h3 className="info-card__header">Login to your account</h3>
                    <input type="text" name="email" className="input__main" placeholder="Email or Username" />
                    <input type="password" name="password" className="input__main" placeholder="Password" />
                    <button type="submit" className="btn__big btn_content">
                        <span className="btn__big--front">
                            {'Log In'}
                        </span>
